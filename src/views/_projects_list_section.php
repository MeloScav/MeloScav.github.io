<section class="projects-wrapper">
            ...
            if (isset($project['type']) && count($project['type']) > 0) {
                foreach ($project['type'] as $projectType) {
                    if ($projectType == $projectsType) {
                        array_unshift($projectsListByType, $project);
                    }
                }
            }
        }
    ...
    <div class="project-banner-waves-wrapper">
        <svg class="project-banner-wave wave-1" data-animate-wave viewBox="0 0 1920 89" fill="none"
        ...
        <svg class="project-banner-wave wave-2" data-animate-wave viewBox="0 0 1920 103" fill="none"
            xmlns="http://www.w3.org/2000/svg">
            <path fill-rule="evenodd" clip-rule="evenodd"
