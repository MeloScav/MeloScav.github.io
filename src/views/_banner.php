<div class="main-banner-wrapper pt-main-nav-height">
    ...
    <div class="main-banner-waves-wrapper">
        <svg class="main-banner-wave wave-1" data-animate-wave viewBox="0 0 1920 73" fill="none"
        ...
        <svg class="main-banner-wave wave-2" data-animate-wave viewBox="0 0 1920 92" fill="none"
            xmlns="http://www.w3.org/2000/svg">
            <path
